...
library Spent {
    // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "Spent", typeId: RESOURCE_TABLE });`
    ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000005370656e740000000000000000000000);
