...
library UpdateId {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "UpdateId", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462000000000000000000000000000055706461746549640000000000000000);
