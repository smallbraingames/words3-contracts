...
library TileLetter {
    // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "TileLetter", typeId: RESOURCE_TABLE
    // });`
    ResourceId constant _tableId = ResourceId.wrap(0x7462000000000000000000000000000054696c654c6574746572000000000000);
