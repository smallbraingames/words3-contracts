...
ResourceId constant _tableId =
    ResourceId.wrap(bytes32(abi.encodePacked(RESOURCE_OFFCHAIN_TABLE, bytes14(""), bytes16("PointsResult"))));
ResourceId constant PointsResultTableId = _tableId;
