...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("TreasuryTable")));
bytes32 constant TreasuryTableTableId = _tableId;

library TreasuryTable {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("TreasuryTable", _fieldNames);
  }
