...
library DrawLetterOdds {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "DrawLetterOdds", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74620000000000000000000000000000447261774c65747465724f6464730000);
