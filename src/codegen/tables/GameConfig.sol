...
FieldLayout constant _fieldLayout = FieldLayout.wrap(0x0047050001200420020000000000000000000000000000000000000000000000);
...
library GameConfig {
    ...
    function set(GameConfigData memory _table) internal {
        bytes memory _staticData = encodeStatic(
            _table.status, _table.endTime, _table.crossWordRewardFraction, _table.maxPlayerSpend, _table.bonusDistance
        );
