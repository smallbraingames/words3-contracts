...
library SpentMove {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "SpentMove", typeId: RESOURCE_OFFCHAIN_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x6f7400000000000000000000000000005370656e744d6f766500000000000000);
