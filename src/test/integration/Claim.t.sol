...
//         vm.assume(
//             winner != 0xCe71065D4017F316EC606Fe4422e11eB2c47c246 && winner !=
...
//         world.start(initialWord, block.timestamp + 1e6, m.getRoot(words), 0.0000001 ether, 1e17, 3e18, 1e16, 3, 5);
//         Letter[] memory word = new Letter[](4);
//         word[0] = Letter.Z;
//         word[1] = Letter.O;
//         word[2] = Letter.EMPTY;
