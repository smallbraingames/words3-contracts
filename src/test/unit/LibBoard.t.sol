...
contract LibBoardTest is Words3Test {
    ...
    function test_GetRelativeCoord() public {
    ...
    function testFuzz_GetRelativeCoord(int32 diff, int32 startX, int32 startY) public {
    ...
    function test_GetCoordsOutsideBound() public {
    ...
    function testFuzz_GetCoordsOutsideBound(
    ...
    function testFuzz_GetCoordsOutsideBoundDoesNotMutate(
        uint16 boundPositive,
        uint16 boundNegative,
        int32 startX,
        int32 startY
        ...
        public
    {
        ...
        assertEq(
            abi.encode(bound), abi.encode(Bound({ positive: boundPositive, negative: boundNegative, proof: proof }))
        );
        LibBoard.getCoordsOutsideBound(letterCoord, Direction.LEFT_TO_RIGHT, bound);
        assertEq(abi.encode(letterCoord), abi.encode(Coord({ x: startX, y: startY })));
        assertEq(
    ...
    function test_GetCrossWord() public {
    ...
    function testFailFuzz_RevertsWhen_GetCrossWord(uint8 a, uint8 b, uint256 c, uint8 e, uint8 f, uint8 g) public {
        bool hasZero = false;
    ...
    function testFuzz_GetCrossWord(
        int32 startX,
        int32 startY,
