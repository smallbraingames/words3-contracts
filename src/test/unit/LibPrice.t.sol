...
contract LibPriceTest is Words3Test {
    ...
    function test_TargetPrice() public {
    ...
    function testFuzz_DoesNotRevertWithReasonableValues(
    ...
    function testFuzz_AroundConstantsDoNotRevertWithReasonableValues(
        uint256 targetPriceRaw,
        uint256 priceDecayRaw,
        uint256 perDayInitialRaw,
        uint256 powerRaw,
    ...
    function test_LinearTargetPrice() public {
        vm.startPrank(deployerAddress);
        VRGDAConfig.set({
            startTime: block.timestamp,
    ...
    function test_LinearPricingBasic() public {
    ...
    function test_LinearAlwaysTargetPriceInRightConditions(uint32 sold) public {
