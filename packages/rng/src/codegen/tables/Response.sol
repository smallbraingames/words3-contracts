...
library Response {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "rng", name: "Response", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462726e670000000000000000000000526573706f6e73650000000000000000);
   ...
   * @notice Get value.
   */
  function get(uint256 id) internal view returns (uint256 value) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));
   ...
   * @notice Get value.
   */
  function _get(uint256 id) internal view returns (uint256 value) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));
   ...
   * @notice Set value.
   */
  function _set(uint256 id, uint256 value) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));
