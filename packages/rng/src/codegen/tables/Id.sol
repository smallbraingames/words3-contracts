...
library Id {
    // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "rng", name: "Id", typeId: RESOURCE_TABLE });`
    ResourceId constant _tableId = ResourceId.wrap(0x7462726e67000000000000000000000049640000000000000000000000000000);
