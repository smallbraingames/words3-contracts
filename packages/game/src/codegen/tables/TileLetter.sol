...
library TileLetter {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "words3", name: "TileLetter", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462776f72647333000000000000000054696c654c6574746572000000000000);
   ...
   */
  function encode(Letter value) internal pure returns (bytes memory, EncodedLengths, bytes memory) {
