...
library DrawCount {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "words3", name: "DrawCount", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462776f72647333000000000000000044726177436f756e7400000000000000);
