...
library Spent {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "words3", name: "Spent", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462776f7264733300000000000000005370656e740000000000000000000000);
