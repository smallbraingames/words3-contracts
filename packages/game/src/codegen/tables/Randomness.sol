...
library Randomness {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "words3", name: "Randomness", typeId: RESOURCE_OFFCHAIN_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x6f74776f72647333000000000000000052616e646f6d6e657373000000000000);
