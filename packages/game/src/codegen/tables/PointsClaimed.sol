...
library PointsClaimed {
    // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "words3", name: "PointsClaimed", typeId:
    // RESOURCE_OFFCHAIN_TABLE });`
    ResourceId constant _tableId = ResourceId.wrap(0x6f74776f726473330000000000000000506f696e7473436c61696d6564000000);
    ...
    function decode(
        ...
        internal
        pure
        returns (PointsClaimedData memory _table)
    {
