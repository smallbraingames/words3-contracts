...
library GameConfig {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "words3", name: "GameConfig", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462776f72647333000000000000000047616d65436f6e666967000000000000);
  ...
  function decodeStatic(
    bytes memory _blob
  ) internal pure returns (Status status, uint32 crossWordRewardFraction, uint16 bonusDistance) {
