...
library PlayerLetters {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "words3", name: "PlayerLetters", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462776f726473330000000000000000506c617965724c657474657273000000);
