...
library Points {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "words3", name: "Points", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462776f726473330000000000000000506f696e747300000000000000000000);
